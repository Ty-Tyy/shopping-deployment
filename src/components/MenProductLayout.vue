...
const fetchMenProducts = async () => {
  try {
    ...
    const menProducts = response.data.filter((item) => item.type?.type_name === 'Men')
    products.value = markRaw(menProducts)
  } catch (error) {
    console.error('Error fetching men’s product data:', error)
  }
}
/**
 * Add Product to Cart
