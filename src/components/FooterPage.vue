<template>
  <footer class="p-4 bg-white sm:p-6 dark:bg-gray-700">
    <div class="mx-auto max-w-screen-2xl">
      <div class="md:flex md:justify-between">
        <div class="mb-6 md:mb-0">
          <a href="" class="flex items-center">
            <img
              src="/src/components/icons/Louis-Vuitton-Logo.png"
              alt="LV logo"
              class="mr-3 h-20 mt-10"
            />
          </a>
        </div>
        <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
          <div>
            ...
            <ul class="text-gray-600 dark:text-gray-400">
              ...
              <li class="mb-1">
                <a href="" class="hover:underline">Perfume</a>
              </li>
            </ul>
          </div>
          <div>
      ...
      <div class="sm:flex sm:items-center sm:justify-between">
        <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400"
          >© 2024 <a href="" class="hover:underline">1Dev™</a>. All Rights Reserved.
        </span>
